...
- July 19, 2025. Reverted from Esri JavaScript API back to Leaflet due to rendering issues and white screen problems. Leaflet provides stable drawing functionality with proper polygon tools.
